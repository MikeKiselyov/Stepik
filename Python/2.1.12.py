...
# В команде биологов 𝑎 человек, а в команде информатиков — 𝑏 человек.
#
...
# Программа должна считывать размеры команд (два положительных целых числа 𝑎 и 𝑏,
# каждое число вводится на отдельной строке) и выводить наименьшее число 𝑑,
# которое делится на оба этих числа без остатка.

x = int(input())
x2 = int(input())
em = 1
while ((em % x != 0) or (em % x2 != 0)):
    em += 1
else:
    print(em)
